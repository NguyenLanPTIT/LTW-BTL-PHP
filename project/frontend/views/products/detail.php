                    ...
                    <div class="section-product-variants">
                        ...
                        <div class="variant">
                            ...
                            <div class="variant__block">
                                <input type="checkbox" name="variant_value[]"
                                    value="<?= $product_variant['variant_value_id']?>" class="variant__value"
                                    id="product-variant--<?= $product_variant['variant_value_id']?>">
...
<div id="fb-comment" class="container facebook-comment">
    <div class="fb-comments" data-href="https://www.facebook.com/" data-numposts="5" data-width=""></div>
</div>
