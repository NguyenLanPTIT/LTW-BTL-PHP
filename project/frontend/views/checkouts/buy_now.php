                ...
                <div class="col-md-7 contact-info">
                    <div class="form-group">
                        ...
                        <input type="text" id="full-name" name="full_name" class="form-control"
                            value="<?php isset($_POST['full_name']) ? $_POST['full_name'] : ''?>" />
                                ...
                                <div class="col-md-8 product-info">
                                    <div class="row">
                                        <div class="col-md-4 product-info__image">
                                            <img class="w-100" src="../backend/assets/uploads/<?= $item['avatar']?>"
                                                alt="">
                        ...
                        <div class="col-md-12 cart-info__detail-main">
                            <div class="row">
                                <div class="col-md-8 product-info">
                                    <div class="row">
                                        <div class="col-md-4 product-info__image">
                                            <img class="w-100" src="../backend/assets/uploads/<?= $product['avatar']?>"
                                                alt="">
