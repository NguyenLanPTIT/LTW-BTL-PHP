    ...
    <div class="container text-center text-md-left">
        ...
        <div class="row text-center text-md-left">
            ...
            <div class="col-md-4 mt-3">
                ...
                <p>
                    <i class="fas fa-home mr-3"></i> Hà Đông, Hà Nội
                </p>
                <p>
                    <i class="fas fa-envelope mr-3"></i> nguyenthilanptit@gmail.com
                </p>
                <p>
                    <i class="fas fa-phone mr-3"></i> + 84376214299
                </p>
            </div>
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <p class="text-center text-md-left">© 2024 Copyright Nguyen Lan
                </p>
