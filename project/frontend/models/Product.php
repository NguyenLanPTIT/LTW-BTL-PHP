...
class Product extends Model
{
    ...
    {
        // Chuẩn bị câu truy vấn SQL lấy ra 8 sản phẩm có số lượng bán cao nhất
        $obj_select_top = $this->connection->prepare("SELECT * FROM products ORDER BY sell_number DESC LIMIT 8");

        // Thực thi câu truy vấn
        $obj_select_top->execute();

        // Lấy dữ liệu sản phẩm và trả về kết quả
        $topProducts = $obj_select_top->fetchAll(PDO::FETCH_ASSOC);
        return $topProducts;
    }
