        ...
        <?php foreach ($managers as $manager): ?>
            <tr>
                ...
                <td class="action">
                    ...
                    <a class="<?= $disabled ?>" title="Update" href="<?php echo $url_update ?>" <?= $disabled_member ?>><i
                            class="fa fa-pencil-alt"></i></a> &nbsp;&nbsp;
                    <a class="<?= $disabled ?>" title="Xóa" href="<?php echo $url_delete ?>" <?= $disabled_member ?>
                        onclick="return confirm('Bạn có chắc chắn xóa người quản trị này?')"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else: ?>
