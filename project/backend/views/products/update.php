    ...
    <form action="" class="form-update" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select name="brand_id" class="form-control" id="brand_id">
                <option value="0" selected="selected">--Nhãn hàng--</option>
        ...
        <div class="form-group">
            ...
            <input type="text" name="product_name"
                value="<?php echo isset($_POST['product_name']) ? $_POST['product_name'] : $product['name'] ?>"
                class="form-control" id="product-name" />
        </div>
        <div class="form-group">
            <label for="avatar">Ảnh bánh ngọt</label>
        ...
        <div class="form-group">
            ...
            <input type="number" name="price"
                value="<?php echo isset($_POST['price']) ? $_POST['price'] : $product['price'] ?>" class="form-control"
                id="price" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control" id="status">
                ...
                ?>
                <option value="0" <?php echo $selected_disabled; ?>>Vô hiệu hóa</option>
                <option value="1" <?php echo $selected_active ?>>Kích hoạt</option>
            </select>
        </div>
        <div class="form-group">
...
function deleteVariant(variant_value_id) {
    $.post(
        ...
        function(data) {
            $('.form-update-content').load(
                "index.php?controller=product&action=update&id=<?= $product['id']?> .form-update");
        }
    )
}
</script>